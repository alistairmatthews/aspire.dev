...
> Before .NET Aspire 13.5, ConfigureCustomDomain was experimental and subject to change or removal in future updates, and using it required suppressing this diagnostic.
...
Before .NET Aspire 13.5, the following code generated `ASPIREACADOMAINS001`:
