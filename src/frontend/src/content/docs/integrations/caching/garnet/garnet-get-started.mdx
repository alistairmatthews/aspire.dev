...
In this introduction, you'll see how to install and use the Aspire Garnet integrations in a simple configuration. If you already have this knowledge, see [Garnet hosting integration](../garnet-host/) for full reference details.
...
- [Garnet hosting integration](../garnet-host/)
- [Garnet client integration](../garnet-client/)
