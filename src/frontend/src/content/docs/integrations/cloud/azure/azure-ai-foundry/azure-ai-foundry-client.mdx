...
The client integration for Azure AI Foundry is provided through the [Azure AI Inference](/integrations/cloud/azure/azure-ai-inference/) integration.
...
See the complete [Azure AI Inference integration documentation](/integrations/cloud/azure/azure-ai-inference/).
