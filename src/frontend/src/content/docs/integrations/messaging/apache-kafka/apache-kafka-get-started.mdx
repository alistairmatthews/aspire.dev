...
In this introduction, you'll see how to install and use the Aspire Apache Kafka integrations in a simple configuration. If you already have this knowledge, see [Apache Kafka hosting integration](../apache-kafka-host/) for full reference details.
...
- [Apache Kafka hosting integration](../apache-kafka-host/)
- [Apache Kafka client integration](../apache-kafka-client/)
