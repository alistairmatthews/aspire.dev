...
<Aside type="note">
    When you call `WithReference` in the AppHost to pass Azure SQL resources to a consuming project, Aspire makes several properties available to that project, such as connection strings, URIs, and port numbers. For a complete list of these properties, see [Properties of the Azure SQL resources](../azure-sql-client/#properties-of-the-azure-sql-resources).
</Aside>
