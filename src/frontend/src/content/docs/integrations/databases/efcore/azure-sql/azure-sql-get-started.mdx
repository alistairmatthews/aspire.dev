---
title: Get started with the Azure SQL integrations
description: Learn how to set up the Aspire Azure SQL Hosting and Client integrations simply.
prev: false
---
...
In this introduction, you'll see how to install and use the Aspire Azure SQL integrations in a simple configuration. If you already have this knowledge, see [Azure SQL Hosting integration](../azure-sql-host/) for full reference details.
...
<Aside type="tip">
    This is the simplest implementation of Azure SQL resources in the AppHost. There are many more options you can choose from to address your requirements. For full details, see [Azure SQL Hosting integration](../azure-sql-host/).
</Aside>
...
<Aside type="tip">
    The full set of properties that Aspire injects depends on the Azure SQL resource configuration. For more information, see [Properties of the Azure SQL resources](../azure-sql-client/#properties-of-the-azure-sql-resources).
</Aside>
