---
title: Azure SQL Client integration reference
description: Learn how to use the Aspire Azure SQL Client integration to interact with Azure SQL databases from your Aspire projects.
next: false
---
...
To get started with the Aspire Azure SQL integrations, follow the [Get started with Azure SQL integrations](../azure-sql-get-started/) guide.

This article includes full details about the Aspire Azure SQL Client integration, which allows you to connect to and interact with Azure SQL databases from your Aspire consuming projects.
